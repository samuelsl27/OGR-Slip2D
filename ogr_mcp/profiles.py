...
TOOLSETS: dict[str, tuple[str, ...]] = {
    ...
    "analysis": ("analysis_run", "job_get", "job_cancel", "job_list",
                 "results_get", "results_query", "surface_evaluate"),
    ...
    "files": ("dxf_inspect", "dxf_import", "dxf_export", "report_generate",
              "properties_import"),
    "groundwater": ("hydraulic_set", "mesh_generate", "mesh_reset",
                    "seepage_bc_set", "seepage_bc_clear", "transient_set",
                    "water_grid_set", "water_grid_delete", "groundwater_run",
                    "groundwater_results", "drawdown_sweep_run"),
    "statistics": ("random_variable_list", "random_variable_set",
                   "random_variable_delete", "statistics_run",
                   "back_analysis_run", "optimize_run"),
    "view": ("model_render",),
