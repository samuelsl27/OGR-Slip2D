...
class ToolMode(Enum):
    ...
    def status_message(self) -> str:
        return {
            ...
            ToolMode.DRAW_ANISOTROPIC_SURFACE: "Draw Anisotropic Surface: click to add vertices IN ORDER (the order decides the angle at a kink), Enter or right-click to finish, Esc to cancel",
