...
_DICTS: dict[str, dict[str, str]] = {
    ...
    "es": {
        ...
        'Define Slope Limits': 'Definir límites del talud',
        'First set of limits': 'Primer juego de límites',
        ...
        'Second set of limits': 'Segundo juego de límites',
        'Slip surfaces must daylight within these limits. Positions are X coordinates.': 'Las superficies de rotura deben aflorar dentro de estos límites. Las posiciones son coordenadas X.',
        'Slope Limits': 'Límites del talud',
        'Slope limit at x = %.4f': 'Límite del talud en x = %.4f',
        ...
        'Slope limits: %.3f to %.3f and %.3f to %.3f': 'Límites del talud: de %.3f a %.3f y de %.3f a %.3f',
        'The right limit must be greater than the left one.': 'El límite derecho debe ser mayor que el izquierdo.',
        'The second set of limits must lie entirely to the right of the first.': 'El segundo juego de límites debe quedar enteramente a la derecha del primero.',
        ...
        'What this run could not do:': 'Lo que esta corrida no pudo hacer:',
        ...
        'Optimize Surfaces': 'Optimizar superficies',
        'All': 'Todas',
        'Applies the Minimum Depth and Minimum Elevation filters, and the concave angle limit, to the surfaces the optimisation produces as well as to those the search generates.': 'Aplica los filtros de profundidad mínima y cota mínima, y el límite de ángulo cóncavo, también a las superficies que produce la optimización, no solo a las que genera la búsqueda.',
        'Explore all vertices before moving surface': 'Explorar todos los vértices antes de mover la superficie',
        'Factor of Safety Less Than:': 'Coeficiente de seguridad menor que:',
        'How far the vertices move on each pass, relative to the previous one. A small value is slow; a large one stops early. 0.5 is the recommended value.': 'Cuánto se mueven los vértices en cada pasada respecto de la anterior. Un valor pequeño va lento; uno grande termina antes de tiempo. Se recomienda 0,5.',
        'Maximum Concave Angle:': 'Ángulo cóncavo máximo:',
        'Maximum Iterations:': 'Iteraciones máximas:',
        ...
        'Specify Distance:': 'Especificar distancia:',
        'Step reduction factor (0 to 1):': 'Factor de reducción del paso (0 a 1):',
        'Surfaces to Optimize': 'Superficies a optimizar',
        'Tolerance (factor of safety):': 'Tolerancia (coeficiente de seguridad):',
        'The optimisation has converged when the factor of safety differs from the average of the last five passes by less than this.': 'La optimización ha convergido cuando el coeficiente de seguridad difiere de la media de las cinco últimas pasadas en menos que esto.',
        'Unticked means no concave angle is allowed between adjacent segments of a surface produced by the optimisation.': 'Sin marcar significa que no se admite ningún ángulo cóncavo entre segmentos contiguos de una superficie producida por la optimización.',
        'Unticked, the minimum allowable depth is derived from the model\'s own relief.': 'Sin marcar, la profundidad mínima admisible se deduce del propio desnivel del modelo.',
        'Use checks for depth, elevation, concave surface': 'Usar las comprobaciones de profundidad, cota y superficie cóncava',
